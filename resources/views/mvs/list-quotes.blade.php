                            ...
                            <div class="card card-p-0 card-flush">
                                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                    ...
                                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                        <button type="button" class="btn btn-primary my-1 py-2" onclick="window.print();">Print Quotes</button>
                                        <!--end::Export dropdown-->
                                    ...
                                    <table class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example">
                                        ...
                                        <tbody class="fw-semibold text-gray-600">
                                            <tr class="odd">
                                                ...
                                                <td>
                                                    <span class="badge py-3 px-4 fs-7 badge-light-primary">Accepted</span>
                                                </td>
                                                ...
                                                <td class="">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item" href="#">Requote</a></li>
														<li><a class="dropdown-item" href="#">Withdraw</a></li>
														<li><a class="dropdown-item" href="#">Sampling</a></li>
                                                    </ul>
                                                </td>
