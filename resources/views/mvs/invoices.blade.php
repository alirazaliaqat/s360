        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Sales Invoices</h1>
                    <!--end::Title-->
                        ...
                        <div class="card card-p-0 card-flush">
                            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                ...
                                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                    ...
                                    <button type="button" class="btn btn-success my-1 py-2" onclick="window.print();">Print Invoice</button>
                                    <!--begin::Menu-->
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td class="">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="#">Issue Performa Invoice </a></li>
                                                <li><a class="dropdown-item" href="#">Issue Invoice </a></li>
                                                <li><a class="dropdown-item" href="#">Sales Return</a></li>
                                                <li><a class="dropdown-item" href="#">Issue Credit Note</a></li>
                                            </ul>
                                        </td>
                                    </tr>
