								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
									...
									<div class="menu-item px-3">
										...
										<div class="menu-item px-5">
											<a href="/mvs/overview" class="menu-link px-5">My Profile</a>
										</div>
										<!--end::Menu item-->
										...
										<!--begin::Menu item-->
										<div class="menu-item px-5">
											<a href="../customer/authentication/sign-in.php" class="menu-link px-5">Sign Out</a>
										</div>
										<!--end::Menu item-->
									</div>
					...
					<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
						...
						<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
							...
							<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
								...
								<div class="menu-item ">
									<!--begin:Menu link-->
									<a class="menu-link {{ (request()->is('mvs')) ? 'active' : '' }}" href="/mvs">
								...
								<div class="menu-item ">
									<!--begin:Menu link-->
									<a class="menu-link {{ (request()->is('mvs/profile*')) ? 'active' : '' }}" href="/mvs/profile">
										<span class="menu-icon">
											<span class="svg-icon svg-icon-2">
												<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<div class="menu-item">
									<!--begin:Menu link-->
									<a class="menu-link {{ (request()->is('mvs/list-rfq*')) ? 'active' : '' }}" href="/mvs/list-rfq">
										<span class="menu-icon">
											<span class="svg-icon svg-icon-2">
												<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<span class="menu-title">Request For Quotes</span>
								...
								<div class="menu-item">
									<!--begin:Menu link-->
									<a class="menu-link {{ (request()->is('mvs/list-quotes*')) ? 'active' : '' }}" href="/mvs/list-quotes">
										<span class="menu-icon">
											<span class="svg-icon svg-icon-2">
												<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<span class="menu-title">Quotes Submitted</span>
								...
								<div class="menu-item">
									<!--begin:Menu link-->
									<a class="menu-link {{ (request()->is('mvs/list-pos*')) ? 'active' : '' }}" href="/mvs/list-pos">
										<span class="menu-icon">
								...
								<div class="menu-item">
									<!--begin:Menu link-->
									<a class="menu-link {{ (request()->is('mvs/invoices*')) ? 'active' : '' }}" href="/mvs/invoices">
										<span class="menu-icon">
											<span class="svg-icon svg-icon-2">
												<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
