						...
						<div class="d-flex flex-column flex-column-fluid">
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div id="kt_app_content_container" class="app-container container-xxl">
									<!--begin::Form-->
									<form id="kt_ecommerce_edit_order_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="../../demo1/supplier/apps/ecommerce/sales/listing.html">
											...
											<div class="card card-flush py-4">
												...
												<div class="card-body pt-0">
													...
													<div class="d-flex flex-column gap-5 gap-md-7">
														...
														<div class="row mt-5">
															<div class="col-6">
																<div class="fs-3 fw-bold mb-n2">Create Sales Invoice</div>
															</div>
															<div class="col-6">
																<!--end::Order details-->
