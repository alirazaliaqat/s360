							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Proforma Invoice</h1>
										<!--end::Title-->
  ...
  <table class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example">
   <thead>
    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase">
																...
																<th class="min-w-100px">p.Invoice#</th>
																<th class="min-w-100px">Invoice Date</th>
																<th class="min-w-100px">PO REF#</th>
																
																<th class="min-w-125px">Customer</th>
																<th class="min-w-100px">Account Manager</th>
																<th class="min-w-100px">Invoice Value</th>
   ...
   <tbody class="fw-semibold text-gray-600">
    ...
    <tr class="odd">
																...
																<td>
																	<span class="badge py-3 px-4 fs-7 badge-light-success">Invoice Granted</span>
																</td>
