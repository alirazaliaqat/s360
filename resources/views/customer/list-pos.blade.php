...
<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
	...
	<div class="d-flex flex-column flex-column-fluid">
		...
		<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
			...
			<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
				...
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					<!--begin::Title-->
					<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">PO</h1>
					<!--end::Title-->
					<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
						...
						<!--begin::Item-->
						<li class="breadcrumb-item text-muted">PO</li>
						<!--end::Item-->
					</ul>
				</div>
				<!--end::Page title-->
								...
								<table class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example">
									<thead>
										<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase">
											...
											<th class="min-w-100px">Aging </th>
											<th >Status</th>
											<th class="min-w-100px">Payment</th>
											
												
											<th class="min-w-100px">TAT </th>
		...
		<div class="card-toolbar text-center mt-6">
									
			<button type="button" class="btn btn-success my-1" onclick="window.print();"><span class="navi-icon"><i class="la la-print"></i></span> Print POs</button>
			<!--begin::Menu-->
