...
<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
	...
	<div class="d-flex flex-column flex-column-fluid">
		...
		<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
			...
			<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
				...
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					<!--begin::Title-->
					<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">RFQ</h1>
					<!--end::Title-->
					<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
						...
						<!--begin::Item-->
						<li class="breadcrumb-item text-muted">RFQ</li>
						<!--end::Item-->
					</ul>
				</div>
				<!--end::Page title-->
		...
		<div id="kt_app_content" class="app-content flex-column-fluid">
						...
						<div class="card-body pt-2">
							...
							<div class="card card-p-0 card-flush">
								<div class="card-header align-items-center py-5 gap-2 gap-md-5">
									...
									<div class="card-toolbar flex-row-fluid justify-content-end gap-5 mt-10 text-center">
										<a href="/customer/new-rfq" class="btn btn-primary my-1">New RFQ</a>
										<!--end::Export dropdown-->
								...
								<div class="card-body">
									...
									<tbody class="fw-semibold text-gray-600">
										...
										<td><a href="/mvs/profile">MVS</a></td>
			...
			<!--end::Table Widget 4-->
			<div class="card-toolbar flex-row-fluid justify-content-end gap-5 mt-10 text-center">
				<button type="button" class="btn btn-success my-1 me-12" onclick="window.print();"><span class="navi-icon">
					<i class="la la-print"></i>
				</span>Print RFQs</button>
				<!--end::Export dropdown-->
