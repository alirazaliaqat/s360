					...
					<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
						...
						<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
							...
							<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
								<!--begin::Title-->
								<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">View Invoice</h1>
								<!--end::Title-->
								<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
									...
									<!--begin::Item-->
									<li class="breadcrumb-item text-muted"><a href="/customer/invoices" class="text-muted text-hover-primary">Invoices</a></li>
									<li class="breadcrumb-item">
										<span class="bullet bg-gray-400 w-5px h-2px"></span>
									</li>
		...
		<div class="flex-lg-row-fluid mb-10 mb-xl-0">
			...
			<div class="mt-n1">
				...
				<div class="d-flex flex-stack pb-10">
					...
					<!--end::Logo-->
					<button type="button" class="btn btn-success my-1" onclick="window.print();"><span class="navi-icon">
                        <i class="la la-print"></i>
                    </span>Print Invoice</button>
				</div>
				<!--end::Top-->
				<!--begin::Wrapper-->
				<div class="m-0">
					<!--begin::Label-->
					<div class="fw-bold fs-3 text-gray-800 mb-8">invoice #12446</div>
					<!--end::Label-->
					<!--begin::Row-->
