            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">View RFQ</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                            ...
                            <div class="card card-p-0 card-flush">
                                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                    ...
                                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5 mt-10 text-center">
										<a href="/customer/list-rfq" class="btn btn-primary my-1">Back to RFQ</a>
										<!--end::Export dropdown-->
                                    ...
                                    <table class="table align-middle border rounded table-row-dashed fs-6 gx-4 gy-1" id="kt_datatable_example">
                                        <thead>
                                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase">
                                                ...
                                                <th class="min-w-100px">Design</th>
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td class="">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item" href="../customer/rfq/edit-rfq.php">Edit</a></li>
                                                    <li><a class="dropdown-item" href="../customer/rfq/view-rfq.php">Delete</a></li>
