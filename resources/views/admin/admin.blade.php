...
<!--begin::Head-->
<head><base href="">
	<title>Sourcer360</title>
	<meta charset="utf-8" />
	<meta name="description" content="Sourcer360" />
	<meta name="keywords" content="Sourcer360" />
	<meta name="viewport" content="width=device-width, initial-scale=1" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:title" content="Sourcer360" />
		...
		<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
			...
			<div id="kt_app_header" class="app-header">
				...
				<div class="app-container container-fluid d-flex align-items-stretch justify-content-between">
					...
					<div class="d-flex align-items-center" title="Show sidebar menu">
						<h2 class="dashboard-m-heading">Welcome to Admin Dashboard</h2>
					</div>
									...
									<div class="menu-item px-3">
										<div class="menu-content d-flex align-items-center px-3">
											...
											<div class="d-flex flex-column">
												<div class="fw-bold d-flex align-items-center fs-5">Ali
													<span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Pro</span></div>
													<a href="#" class="fw-semibold text-muted text-hover-primary fs-7">info@dunesberry.com</a>
												</div>
												<!--end::Username-->
											</div>
										</div>
										...
										<div class="menu-item px-5">
											<a href="../admin/account/overview.php" class="menu-link px-5">My Profile</a>
										</div>
										<!--end::Menu item-->
										...
										<!--begin::Menu item-->
										<div class="menu-item px-5">
											<a href="../admin/account/statements.php" class="menu-link px-5">My Statements</a>
										</div>
										<!--end::Menu item-->
										<!--begin::Menu separator-->
										<div class="separator my-2"></div>
										...
										<div class="menu-item px-5 my-1">
											<a href="../admin/account/settings.php" class="menu-link px-5">Account Settings</a>
										</div>
										<!--end::Menu item-->
										<!--begin::Menu item-->
										<div class="menu-item px-5">
											<a href="../admin/authentication/sign-in.php" class="menu-link px-5">Sign Out</a>
										</div>
										<!--end::Menu item-->
									</div>
				...
				<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
					...
					<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
						...
						<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
							<!--begin::Logo image-->
							<h2><a href="/admin">
								<img alt="Logo" src="{{ asset('assets/media/logos/s360logo.png')}}" class="h-50px app-sidebar-logo-default" />
						...
						<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
							...
							<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
								...
								<ul class="ps-0">
									...
									<!--end:Menu item-->
									<li>
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ (request()->is('admin/customer-rfqs*')) ? 'show' : '' }}">
											<!--begin:Menu link-->
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="/admin/customer-rfqs">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">List RFQs</span>
													</a>
													<!--end:Menu link-->
												</div>
									...
									<!--end:Menu item-->
									<li>
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ (request()->is('admin/quotes-to-customer*')) ? 'show' : '' }}">
											<!--begin:Menu link-->
											<span class="menu-link">
												<span class="menu-icon">
													<span class="svg-icon svg-icon-2">
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item">
													...
													<a class="menu-link" href="/admin/quotes-to-customer">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">List Quotes</span>
													</a>
									...
									<li>
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ (request()->is('admin/list-pos*')) ? 'show' : '' }}">
											<!--begin:Menu link-->
											<span class="menu-link">
												<span class="menu-icon">
													<span class="svg-icon svg-icon-3">
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<!--<div class="menu-item">
													...
													<a class="menu-link" href="/admin/create-po">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="/admin/list-pos">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
									...
									<li>
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ (request()->is('admin/*sales-invoice*')) ? 'show' : '' }}">
											<!--begin:Menu link-->
											<span class="menu-link">
												<span class="menu-icon">
													...
													<span class="svg-icon svg-icon-2">
														<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
															...
															<path id="svg_1" fill="currentColor" d="m20,8l-4,0c-0.6,0 -1,0.4 -1,1l0,7l-5,0l0,1c0,0.6 0.4,1 1,1l5,0c0,-1.1 0.9,-2 2,-2c1.1,0 2,0.9 2,2l1,0c0.6,0 1,-0.4 1,-1l0,-4l-2,-5z"/>
															<path id="svg_2" fill="currentColor" d="m20,18c0,1.1 -0.9,2 -2,2c-1.1,0 -2,-0.9 -2,-2c0,-1.1 0.9,-2 2,-2c1.1,0 2,0.9 2,2zm-5,-14c0,-0.6 -0.4,-1 -1,-1l-11,0c-0.6,0 -1,0.4 -1,1l0,9c0,0.6 0.4,1 1,1l12,0l0,-10zm-9,12c-1.1,0 -2,0.9 -2,2c0,1.1 0.9,2 2,2c1.1,0 2,-0.9 2,-2c0,-1.1 -0.9,-2 -2,-2z" opacity="0.3"/>
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="/admin/list-sales-invoice">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">List Sales Invoices</span>
													</a>
													<!--end:Menu link-->
												</div>
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="/admin/create-sales-invoice">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
									...
									<li>
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ (request()->is('admin/list-customers*')) ? 'show' : '' }}">
											<!--begin:Menu link-->
											<span class="menu-link">
												<span class="menu-icon">
													<span class="svg-icon svg-icon-2">
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item ">
													<!--begin:Menu link-->
													<a class="menu-link" href="/admin/list-customers">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
									...
									<!--end:Menu item-->
									<li>
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ (request()->is('admin/list-mvs*')) ? 'show' : '' }}">
											<!--begin:Menu link-->
											<span class="menu-link">
												<span class="menu-icon">
													<span class="svg-icon svg-icon-2">
												...
												<span class="menu-title">MVS</span>
												<span class="menu-arrow"></span>
											</span>
											<!--end:Menu link-->
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="/admin/list-mvs">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">List MVS</span>
													</a>
													<!--end:Menu link-->
												</div>
									...
									<li>
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ (request()->is('admin/mvs-quotes*')) ? 'show' : '' }}">
											<!--begin:Menu link-->
											<span class="menu-link">
												<span class="menu-icon">
													<span class="svg-icon svg-icon-2">
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="/admin/mvs-quotes">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">List Quotes</span>
									...
									<!--end:Menu item-->
									<li>
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ (request()->is('admin/*product*')) ? 'show' : '' }}">
											<!--begin:Menu link-->
											<span class="menu-link">
												<span class="menu-icon">
													<!--begin::Svg Icon | path: icons/duotune/files/fil003.svg-->
													<span class="svg-icon svg-icon-2">
														<svg width="20" height="19" xmlns="http://www.w3.org/2000/svg">
															...
															<path fill="currentColor" d="m16,8l0,10c0,0.6 0.4,1 1,1c0.6,0 1,-0.4 1,-1l0,-10l-2,0z" opacity="0.3"/>
															<path fill="currentColor" d="m9,8l0,7l-5,0l0,-7l-2,0l0,10c0,0.6 0.4,1 1,1l7,0c0.6,0 1,-0.4 1,-1l0,-10l-2,0z" opacity="0.3"/>
															<path fill="currentColor" d="m8,8c0,1.1 -0.9,2 -2,2c-1.1,0 -2,-0.9 -2,-2l4,0z" opacity="0.3"/>
															<path fill="currentColor" d="m16,8c0,1.1 -0.9,2 -2,2c-1.1,0 -2,-0.9 -2,-2l4,0z" opacity="0.3"/>
															<path fill="currentColor" d="m12,2l-4,0l0,6l4,0l0,-6z" opacity="0.3"/>
															<path fill="currentColor" d="m15,2l3,0l2,6l-4,0l-1,-6z" opacity="0.3"/>
															<path fill="currentColor" d="m5,2l-3,0l-2,6l4,0l1,-6z" opacity="0.3"/>
															<path fill="currentColor" d="m4,8c0,1.1 -0.9,2 -2,2c-1.1,0 -2,-0.9 -2,-2l4,0zm4,0c0,1.1 0.9,2 2,2c1.1,0 2,-0.9 2,-2l-4,0zm8,0c0,1.1 0.9,2 2,2c1.1,0 2,-0.9 2,-2l-4,0zm1,-8l-14,0c-0.6,0 -1,0.4 -1,1l0,1l16,0l0,-1c0,-0.6 -0.4,-1 -1,-1zm-7,15c0,-0.6 -0.4,-1 -1,-1l-5,0c-0.6,0 -1,0.4 -1,1c0,0.6 0.4,1 1,1l5,0c0.6,0 1,-0.4 1,-1z"/>
															
														</svg>
													</span>
													<!--end::Svg Icon-->
												</span>
												<span class="menu-title">Product Database</span>
												<span class="menu-arrow"></span>
											</span>
											<!--end:Menu link-->
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="/admin/list-products">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
					...
					<div class="rounded border border-dashed border-gray-300 p-6 p-lg-8 mb-10">
						...
						<div class="d-flex align-items-center mb-7">
							...
							<div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
								...
								<div class="d-flex flex-column me-2 me-lg-5">
									<!--begin::Title-->
									<a href="../../demo1/admin/documentation/getting-started.html" class="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">Documentation &amp; Videos</a>
									<!--end::Title-->
									<!--begin::Description-->
						...
						<div class="d-flex align-items-center mb-7">
							...
							<div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
								...
								<div class="d-flex flex-column me-2 me-lg-5">
									<!--begin::Title-->
									<a href="../../demo1/admin/documentation/base/utilities.html" class="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">Plugins &amp; Components</a>
									<!--end::Title-->
									<!--begin::Description-->
						...
						<div class="d-flex align-items-center mb-7">
							...
							<div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
								...
								<div class="d-flex flex-column me-2 me-lg-5">
									<!--begin::Title-->
									<a href="../../demo1/admin/documentation/getting-started/changelog.html" class="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">What's New</a>
									<!--end::Title-->
									<!--begin::Description-->
