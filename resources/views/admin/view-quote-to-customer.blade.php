			...
			<div class="mt-n1">
				...
				<div class="m-0">
					...
					<div class="fw-semibold fs-7 text-gray-600 mb-1"><span class="text-gray-800 fs-6">Currency:</span> Saudi Riyal</div>
                     <!-- <div class="fw-semibold fs-7 text-gray-600 mb-1 mt-3">
                     	<span class="text-gray-800 fs-6">
                     		Add Margin: <input type="text" class="form-control d-inline w-100px" name="margin" placeholder="Margin %"><button type="submit" class="btn btn-primary py-2 ms-3"> Add</button>
                     </div> -->
