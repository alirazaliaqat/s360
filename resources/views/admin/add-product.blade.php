	...
	<div class="d-flex flex-column flex-column-fluid">
		...
		<div id="kt_app_content" class="app-content flex-column-fluid">
			...
			<div id="kt_app_content_container" class="app-container container-xxl">
				<!--begin::Form-->
				<form  action="/admin/add-product" method="POST" class="form d-flex flex-column flex-lg-row">
					@csrf
					<!--begin::Main column-->
						...
						<div class="card card-flush py-4">
							...
							<div class="card-body pt-0">
								...
								<div class="d-flex flex-column gap-5 gap-md-7">
									...
									<div class="row mt-5">
										<div class="col-6">
											<div class="fs-3 fw-bold mb-n2">Add Product</div>
										</div>
										<div class="col-6">
											<!--end::Order details-->
										...
										<div class="row">
											...
											<div class="col-6">
												<div class="row">
													<label class="form-label col-md-4 required my-auto">Product Name</label>
													<div class="col-md-8 mb-4">
														<input  type="text" name="product_name" placeholder="Product Name" class="form-control" value="" required/>
													</div>
												</div>
											</div>
											...
											<div class="col-6">
												<div class="row">
													...
													<label class="form-label col-md-4 required my-auto">Product Description</label>
													<div class="col-md-8">
														<input type="text" name="product_description" placeholder="Product Description" class="form-control" value="" required/>
													</div>
												</div>
											</div>
											...
											<div class="col-6">
												<div class="row">
													...
													<label class="form-label col-md-4 required my-auto">SKU</label>
													<div class="col-md-8">
											...
											<div class="col-6 mb-4">
												<div class="row">
													...
													<label class="form-label col-md-4 required my-auto">Category</label>
													<div class="col-md-8">
											...
											<div class="col-6 mb-4">
												<div class="row">
													<label class="form-label col-md-4 required my-auto">Category Type</label>
													<div class="col-md-8">
														
														<input type="text" class="form-control" name="category_type" placeholder="Category Type" value="" required/>
													</div>
												</div>
											</div>
											<div class="col-6">
												<div class="row">
													<label class="form-label col-md-4 required my-auto">UOM</label>
													<div class="col-md-8">
														<input type="text" class="form-control" name="uom" placeholder="UOM" value="" required/>
													</div>
												</div>
											</div>
											...
											<div class="col-6 mb-4">
												<div class="row">
													<label class="form-label col-md-4 my-auto">Product Code</label>
													<div class="col-md-8">
														<input type="text" class="form-control" name="product_code" placeholder="Product Code" value="" required/>
													</div>
												</div>
											</div>
											...
											<div class="col-6 mb-4">
												<div class="row">
													<label class="form-label col-md-4 my-auto">Part No.</label>
													<div class="col-md-8">
														<input type="text" class="form-control" name="part_no" placeholder="Part No." value="" required/>
													</div>
												</div>
											</div>
											<div class="col-6 mb-4">
												<div class="row">
													<label class="form-label col-md-4 my-auto">Model No.</label>
													<div class="col-md-8">
														<input type="text" class="form-control" name="model_no" placeholder="Model No." value="" required/>
													</div>
												</div>
											</div>
					...
					<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
						...
						<div class="d-flex flex-column flex-column-fluid">
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Add a Product</h1>
										<!--end::Title-->
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div id="kt_app_content_container" class="app-container container-xxl">
									<!--begin::Form-->
									<form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="../../demo1/admin/apps/ecommerce/catalog/products.html">
										<!--begin::Aside column-->
										<div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
											...
											<div class="card card-flush py-4">
												...
												<div class="card-body text-center pt-0">
													...
													<style>.image-input-placeholder { background-image: url('{{ asset('assets/media/svg/files/blank-image.svg')}}'); } [data-theme="dark"] 
													.image-input-placeholder { background-image: url('{{ asset('assets/media/svg/files/blank-image-dark.svg')}}'); }</style>
													<!--end::Image input placeholder-->
													<div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3" data-kt-image-input="true" style="&lt;br /&gt; &lt;b&gt;Warning&lt;/b&gt;: Undefined variable $imageBg in &lt;b&gt;C:\wamp64\www\keenthemes\core\html\admin\view\pages\apps\ecommerce\catalog\edit-product\_thumbnail.php&lt;/b&gt; on line &lt;b&gt;30&lt;/b&gt;&lt;br /&gt;">
											...
											<div class="card card-flush py-4">
												...
												<div class="card-body pt-0">
													...
													<!--end::Input group-->
													<!--begin::Button-->
													<a href="../../demo1/admin/apps/ecommerce/catalog/add-category.html" class="btn btn-light-primary btn-sm mb-10">
										...
										<div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
											...
											<div class="d-flex justify-content-end">
												<!--begin::Button-->
												<a href="../../demo1/admin/apps/ecommerce/catalog/products.html" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">Cancel</a>
												<!--end::Button-->
												<!--begin::Button-->
